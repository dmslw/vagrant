Vagrant.configure("2") do |config|
  config.vm.define "ubuntu1" do |ubuntu1|
    ...
    ubuntu1.vm.network "public_network", bridge:"my-network", ip: "192.168.4.106"
  ...
  config.vm.define "ubuntu2" do |ubuntu2|
    ...
    ubuntu2.vm.network "public_network", bridge:"my-network", ip: "192.168.4.107"
  ...
  config.vm.define "ubuntu3" do |ubuntu3|
    ...
    ubuntu3.vm.network "public_network", bridge:"my-network", ip: "192.168.4.108"
  ...
  config.vm.define "ubuntu4" do |ubuntu4|
    ubuntu4.vm.box = "ubuntu/focal64"
    ubuntu4.vm.hostname = "ubuntu4"
    ubuntu4.vm.network "public_network", bridge:"my-network", ip: "192.168.4.109"
    #ubuntu3.vm.network "public_network", bridge: "en0: Wi-Fi (AirPort)", ip: "2a01:4f9:3a:3c0b::100"
    ubuntu4.vm.network "forwarded_port", guest: 22, host: 2225
